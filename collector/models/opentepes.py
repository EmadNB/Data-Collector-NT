...
_THERMAL_ENTRIES: list[tuple[str, str, str, bool, int | None]] = [
    ...
    ("Gas (ccgt_pre1) (MW)",   "Gas_pre1",     "Gas",          False, 13),
    ("Gas (ccgt_pre2) (MW)",   "Gas_pre2",     "Gas",          False, 14),
    ("Gas (ccgt_new) (MW)",    "Gas_ccgt_new", "Gas",          False, 15),
    ("Gas (ccgt_ccs) (MW)",    "Gas_ccgt_ccs", "Gas",          False, 16),
    ("Gas (ocgt_old) (MW)",    "Gas_ocgt1",    "Gas",          False, 17),
    ("Gas (ocgt_new) (MW)",    "Gas_ocgt2",    "Gas",          False, 18),
    ("Light Oil (MW)",         "Oil_light",    "Oil",          False, 19),
    ("Heavy oil (old1) (MW)",  "Oil_heavy1",   "Oil",          False, 20),
    ("Heavy oil (old2) (MW)",  "Oil_heavy2",   "Oil",          False, 21),
    ("Oil shale (old) (MW)",   "OilShale1",    "Oil",          False, 22),
    ("Oil shale (new) (MW)",   "OilShale2",    "Oil",          False, 23),
